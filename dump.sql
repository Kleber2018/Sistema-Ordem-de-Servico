...
INSERT INTO SMICL(LOC_CODIGO, LOC_NIVEL, LOC_TITULO, LOC_EQUIPE, FN_CODIGO) VALUES ('AA', '1', 'Almoxarifado', 'EQUIPE-01', 'KLEBER');
INSERT INTO SMICL(LOC_CODIGO, LOC_NIVEL, LOC_TITULO, LOC_EQUIPE, FN_CODIGO) VALUES ('AB', '2', 'Estante-A', 'EQUIPE-01', 'KLEBER');
INSERT INTO SMICL(LOC_CODIGO, LOC_NIVEL, LOC_TITULO, LOC_EQUIPE, FN_CODIGO) VALUES ('AC', '3', 'Prateleira do cima', 'EQUIPE-01', 'KLEBER');
INSERT INTO SMICL(LOC_CODIGO, LOC_NIVEL, LOC_TITULO, LOC_EQUIPE, FN_CODIGO) VALUES ('AX', '3', 'Prateleira de baixo', 'EQUIPE-01', 'KLEBER');
INSERT INTO SMICL(LOC_CODIGO, LOC_NIVEL, LOC_TITULO, LOC_EQUIPE, FN_CODIGO) VALUES ('AF', '2', 'Estante-B', 'EQUIPE-01', 'KLEBER');
...
INSERT INTO SMIOS(OS_CODIGO, OS_OBS, OS_DATA_P, OS_NOME_RESP, OS_TIPO, OS_TITULO, OS_STATUS, LOC_CODIGO, FN_CODIGO) VALUES ('AX:9', 'QUALQUER OBS', NOW(), 'KLEBER', 'CNE', 'Falta de energia', 'PENDENTE', 'AX', 'KLEBER');

INSERT INTO SMIOS(OS_CODIGO, OS_OBS, OS_DATA_P, OS_NOME_RESP, OS_TIPO, OS_TITULO, OS_STATUS, LOC_CODIGO, FN_CODIGO) VALUES ('AF:9', 'QUALQUER OBS', NOW(), 'KLEBER', 'CNE', 'Falta de energia', 'EXECUTADO', 'AX', 'KLEBER');
INSERT INTO SMIOS(OS_CODIGO, OS_OBS, OS_DATA_P, OS_NOME_RESP, OS_TIPO, OS_TITULO, OS_STATUS, LOC_CODIGO, FN_CODIGO) VALUES ('AF:18', 'QUALQUER OBS', NOW(), 'KLEBER', 'CEG', 'Falta de energia', 'EXECUTADO', 'AX', 'KLEBER');
INSERT INTO SMIOS(OS_CODIGO, OS_OBS, OS_DATA_P, OS_NOME_RESP, OS_TIPO, OS_TITULO, OS_STATUS, LOC_CODIGO, FN_CODIGO) VALUES ('AF:27', 'QUALQUER OBS', NOW(), 'KLEBER', 'CNE', 'Falta de energia', 'EXECUTADO', 'AX', 'KLEBER');
INSERT INTO SMIOS(OS_CODIGO, OS_OBS, OS_DATA_P, OS_NOME_RESP, OS_TIPO, OS_TITULO, OS_STATUS, LOC_CODIGO, FN_CODIGO) VALUES ('AF:36', 'QUALQUER OBS', NOW(), 'KLEBER', 'PNS', 'Falta de energia', 'EXECUTADO', 'AX', 'KLEBER');