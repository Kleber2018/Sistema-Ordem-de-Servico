<section class="columns is-fullheight">
  ...
  <aside class="column is-2 aside menu is-fullheight">
    ...
    <ul class="menu-list ">
        ...
        <li class="menu-item"><a <?php if($viewVar['nameController'] == "ServicoController") { ?> class="is-active" <?php } ?> href="http://<?php echo APP_HOST; ?>/servico/chamaViewServicoTela"><i class="fa fa-cog"></i> Tela de Serviço</a></li>
